...
class Game:
    ...
    def __init__(
        self,
        start_at: Location,
        player: Character, # Type Hinting that player is going to be Character object
        characters=None,
        custom_actions=None,
    ):
        ...
        self.characters = {}
        self.add_character(player) # Adding player to this game object
        self.start_at.add_character(player) # adding player to the starting location object
        self.start_at.has_been_visited = True # Setting that the starting location has been visited
